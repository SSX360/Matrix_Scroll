 ...
 * - Ecosystem bar: Matrix Scroll ↔ SSX360 control plane
 * - Developer-protocol nav on homepage; docs/MCP nav elsewhere
...
(function () {
  ...
  var HOME_ANCHORS = [
    { href: "/#problem", label: "The Blindspot", match: [] },
    { href: "/#anatomy", label: "How it Signs", match: [] },
    { href: "/#terminal", label: "Try CLI", match: [] },
    { href: "/#comparison", label: "Compare", match: [] },
  ]
  ...
  function buildNav(path) {
    ...
    var navItems = isHome ? HOME_ANCHORS : PRIMARY

    var primary = navItems.map(function (item) {
    ...
    var pypiBadge =
      '<a class="nav-pypi" href="https://pypi.org/project/matrixscroll/0.4.2/" target="_blank" rel="noopener noreferrer" title="PyPI 0.4.2">PyPI 0.4.2</a>'
    ...
    return (
      ...
      "</div></details>" +
      '<a class="nav-external nav-external-desktop nav-ssx360" href="https://ssx360.com/" target="_blank" rel="noopener noreferrer"><span class="nav-pulse" aria-hidden="true"></span> SSX360 <span aria-hidden="true">↗</span></a>' +
      '<a class="nav-cta" href="' +
      (isHome ? "/docs/" : "/mcp/") +
      '">' +
      (isHome ? "pip install" : "Get MCP") +
      "</a>" +
      "</div>"
    )
  }
    ...
    root.querySelectorAll("a").forEach(function (a) {
      ...
      if (text.indexOf("PyPI 0.3.0") !== -1) {
        ...
        if (!a.href || a.getAttribute("href") === "#") {
          a.href = "https://pypi.org/project/matrixscroll/0.4.2/"
        }
      }
    })
  }
  ...
  function init() {
    ...
    normalizeLegacyLinks(document.body)
    normalizeFooter()
